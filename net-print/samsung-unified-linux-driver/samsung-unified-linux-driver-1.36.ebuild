...
SRC_URI="http://org.downloadcenter.samsung.com/downloadfile/ContentsFile.aspx?VPath=DR/201510/20151028120356557/uld_v1.00.36_00.91.tar.gz -> ${P}.tar.gz"
...
src_install() {
	...
	doexe ${SABI}/rastertospl ${SABI}/pstosecps
	...
	# be found.
	# /usr/${SLIBDIR}/cups/filter
	
	insinto ${ROOT}usr/${SLIBDIR}/cups/filter
	doins ${SABI}/libscmssc.so
